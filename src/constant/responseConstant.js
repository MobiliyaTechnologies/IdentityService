...
constants.FLEET_NULL_ERROR = 1137;
constants.SUPERADMIN_DELETION_ERROR = 1138;
constants.TENANT_DELETION_ERROR = 1139;
constants.FLEETADMIN_DELETION_ERROR = 1140;
constants.DRIVER_DELETION_ERROR = 1141;
constants.VEHICLE_ASSIGN_ERROR = 1142;
